...
const WorkExperience = ({ key, experience }: { key: number, experience: WorkExperienceDetails }) => {
  ...
  return (
    <div key={key} className="max-w-lg mx-auto my-8">
      ...
      <p className="text-md text-secondary font-semibold">{experience.start.toLocaleDateString("default", dateOptions)} - {experience.end ? experience.end.toLocaleDateString("default", dateOptions) : "Present"}</p>
